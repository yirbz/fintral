...
export default function PrintInvoicePage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-100 dark:bg-neutral-900 py-6 print:py-0 flex flex-col items-center">
      ...
      <div className="w-[80mm] bg-white dark:bg-black text-black dark:text-white p-4 font-mono text-[10px] shadow-md print:shadow-none border border-neutral-200 dark:border-neutral-800 print:border-none leading-tight">
        {/* Header */}
