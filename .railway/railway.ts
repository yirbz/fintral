...
export default defineRailway(() => {
  ...
  const lago = service("lago", {
    ...
    env: {
      ...
      LAGO_DOMAIN: preserve(),
      LAGO_FRONT_URL: preserve(),
      RAILS_ENV: preserve(),
  ...
  const fintralBackend = service("fintral-backend", {
    ...
    env: {
      ...
      PUBLIC_APP_URL_ALTERNATE: preserve(),
  ...
  return project("fintral-backend-staging", {
    resources: [lago, lagoPostgres, fintralBackend],
  });
});
