...
from app.routers import admin, auth_pages, dgii, evolution, history, integrations, invitations, invoices, notifications, odoo_integration, organizations, pending_uploads, quickbooks_integration, settings, statistics, websocket, webhooks, xero_integration, bank_accounts, billing, ai_chat, plans, reports, support_chat
